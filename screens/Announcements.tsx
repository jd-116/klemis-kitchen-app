...
type AnnouncementsNavigationProp = DrawerNavigationProp<DrawerParamList, 'Announcements'>
...
type APIAnnouncement = {
  ...
  export default function Announcements({ navigation, route }: Props): React.ReactElement {
