...
export default {
  ...
  tabActiveBgColor: '#83BDA8',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: '#83BDA8',
  ...
  radioSelectedColorAndroid: '#83BDA8',
